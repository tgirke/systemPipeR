...
- Each _`SYSargs`_ instances are constructed from a _`targets`_ file and a _`param`_ file.

- Only first _`targets`_ file needs to be provided by user. Subsequent _`target`_ instances are created automatically. 
