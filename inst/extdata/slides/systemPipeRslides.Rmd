...
$ make -B
```
- Analysis reports in PDF or HTML format are autogenerated along with each workflow using standard R resources for scientific report generation including _`knitr`_ and _`rmarkdown`_, respectively.
...
- Workflow templates for both PDF (.Rnw) and HTML (.Rmd) reports
- Workflow templates for additional NGS applications
- Support for more complex experimental designs
