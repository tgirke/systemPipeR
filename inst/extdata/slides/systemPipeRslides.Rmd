...
$ make -B
```
- Analysis reports in PDF or HTML format are autogenerated at the end of each workflow with standard R resources for scientific report generation including _`knitr`_ and _`rmarkdown`_, respectively.
