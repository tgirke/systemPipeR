...
- Many NGS applications share the same or very similar analysis routines such as: 
    - Read QC and preprocessing
    - Alignments
    - Quantification
    - Feature annotation routines
    - Enrichment analysis
- Thus, a common workflow environment has many advantages in imporving efficiency, standardization and reproducibility
...
```
<br></br>
The above structure can be customized as needed, but for first time users it is easier to leave it as is.
