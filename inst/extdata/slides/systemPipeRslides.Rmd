...
$ make -B
```
- Analysis reports in PDF or HTML format are autogenerated at the end of each workflow with standard R resources _`knitr`_ or _`rmarkdown`_, respectively.
