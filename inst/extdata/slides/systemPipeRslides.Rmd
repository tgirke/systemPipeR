...
clusterRun(args, ...) 
```
The last step requires several resource allocation arguments. For details please visit the main manual [here](http://www.bioconductor.org/packages/devel/bioc/vignettes/systemPipeR/inst/doc/systemPipeR.html#alignment-with-tophat2).
