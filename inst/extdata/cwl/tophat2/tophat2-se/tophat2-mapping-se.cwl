...
outputs:
  accepted_hits_bam:
    type: File
    outputBinding:
      glob: $(inputs.results_path)/$(inputs.SampleName)/accepted_hits.bam
  junctions_bed:
    type: File
    outputBinding:
      glob: $(inputs.results_path)/$(inputs.SampleName)/junctions.bed
  insertions_bed:
    type: File
    outputBinding:
      glob: $(inputs.results_path)/$(inputs.SampleName)/insertions.bed
  deletions_bed:
    type: File
    outputBinding:
      glob: $(inputs.results_path)/$(inputs.SampleName)/deletions.bed
  align_summary:
    type: File
    outputBinding:
      glob: $(inputs.results_path)/$(inputs.SampleName)/align_summary.txt
