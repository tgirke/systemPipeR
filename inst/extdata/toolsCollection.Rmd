...
```{r, spr='sysargs'}
args <- loadWF(targets = NULL, wf_file = "bwa/bwa-index.cwl", 
...
```{r, spr='sysargs'}
args <- loadWF(targets = targetspath, wf_file = "fastqc/fastqc.cwl", 
...
```{r, spr='sysargs'}
args <- loadWF(targets = targetspath, wf_file = "hisat2/hisat2-mapping-se.cwl", 
