...
WF_test <- loadWorkflow(targets = targetspath, wf_file="example.cwl",
                   input_file="example.yml", dir_path = system.file("extdata/cwl/example/", package="systemPipeR"))
WF_test <- renderWF(WF_test, inputvars = c(Message = "_STRING_", SampleName = "_SAMPLE_"))
```
