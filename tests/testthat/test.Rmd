...
```{r setup_libraries, echo=FALSE, message=FALSE, warning=FALSE, spr='r', eval=TRUE}
...
```{r quality, spr='sysargs', eval=TRUE}
targetspath <- system.file("extdata", "targetsPE.txt", package = "systemPipeR")
...
```{r check_files_exist, eval=TRUE, spr='r'}
...
```{r read_counting, eval=TRUE, spr='r'}
...
```{r view_counts, eval=TRUE, spr='r'}
read.delim("results/countDFeByg.xls", row.names=1, check.names=FALSE)[1:4,1:5]
```

Sample of data slice of RPKM table

```{r view_rpkm, eval=TRUE, spr='r'}
