...
trends. Functions are provided for evaluating of the quality of Ribo-seq data,
...
regulation.  For quality control puposes of Ribo-Seq experiments it is also
useful to monitor the abundance of reads mapping to rRNA genes due to the high
rRNA content of ribosomes. This information can be generated with the above
described \Rfunction{featuretypeCounts} function.
...
transcripts occupied with ribosomes in their uORF regions. The binding of
