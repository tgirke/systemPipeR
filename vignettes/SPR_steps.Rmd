...
```{r construct_SYSargs2_trim-se, echo = FALSE, eval=TRUE}
targetspath <- system.file("extdata", "targets.txt", package="systemPipeR")
dir_path <- system.file("extdata/cwl", package="systemPipeR")
trim <- loadWorkflow(targets=targetspath, wf_file="preprocessReads/trim-se.cwl", 
...
```{r construct_SYSargs2_trim-pe, eval=TRUE}
targetsPE <- system.file("extdata", "targetsPE.txt", package="systemPipeR")
dir_path <- system.file("extdata/cwl", package="systemPipeR")
trim <- loadWorkflow(targets=targetsPE, wf_file="preprocessReads/trim-pe.cwl", 
...
targetspath <- system.file("extdata", "targets.txt", package="systemPipeR")
dir_path <- system.file("extdata/cwl", package="systemPipeR")
trimG <- loadWorkflow(targets=targetspath, wf_file="trim_galore/trim_galore-se.cwl", 
...
targetsPE <- system.file("extdata", "targetsPE.txt", package="systemPipeR")
dir_path <- system.file("extdata/cwl", package="systemPipeR")
trimM <- loadWorkflow(targets=targetsPE, wf_file="trimmomatic/trimmomatic-pe.cwl", 
...
dir_path <- system.file("extdata/cwl", package="systemPipeR")
idx <- loadWorkflow(targets=NULL, wf_file="hisat2/hisat2-index.cwl", 
...
WF <- loadWorkflow(targets=targetspath, wf_file="workflow-hisat2/workflow_hisat2-se.cwl", 
                   input_file="workflow-hisat2/workflow_hisat2-se.yml", dir_path=dir_path)
...
dir_path <- system.file("extdata/cwl", package="systemPipeR")
idx <- loadWorkflow(targets=NULL, wf_file="bowtie2/bowtie2-index.cwl", 
...
targetsPE <- system.file("extdata", "targetsPE.txt", package = "systemPipeR")
dir_path <- system.file("extdata/cwl", package="systemPipeR")
tophat2PE <- loadWorkflow(targets = targetsPE, wf_file = "tophat2/tophat2-mapping-pe.cwl", 
...
targetsPE <- system.file("extdata", "targetsPE.txt", package = "systemPipeR")
dir_path <- system.file("extdata/cwl", package="systemPipeR")
bowtiePE <- loadWorkflow(targets = targetsPE, wf_file = "bowtie2/bowtie2-mapping-pe.cwl", 
...
dir_path <- system.file("extdata/cwl", package="systemPipeR")
idx <- loadWorkflow(targets=NULL, wf_file="bwa/bwa-index.cwl", 
...
targetsPE <- system.file("extdata", "targetsPE.txt", package = "systemPipeR")
dir_path <- system.file("extdata/cwl", package="systemPipeR")
bwaPE <- loadWorkflow(targets = targetsPE, wf_file = "bwa/bwa-pe.cwl", 
...
## Build the index:
dir_path <- system.file("extdata/cwl", package="systemPipeR")
idx <- loadWorkflow(targets = NULL, wf_file = "rsubread/rsubread-index.cwl", 
...
targetspath <- system.file("extdata", "targets.txt", package = "systemPipeR")
dir_path <- system.file("extdata/cwl", package="systemPipeR")
rsubread <- loadWorkflow(targets = targetspath, wf_file = "rsubread/rsubread-mapping-se.cwl", 
...
## Build the index:
dir_path <- system.file("extdata/cwl", package="systemPipeR")
idx <- loadWorkflow(targets = NULL, wf_file = "gsnap/gsnap-index.cwl", 
...
targetsPE <- system.file("extdata", "targetsPE.txt", package = "systemPipeR")
dir_path <- system.file("extdata/cwl", package="systemPipeR")
gsnap <- loadWorkflow(targets = targetsPE, wf_file = "gsnap/gsnap-mapping-pe.cwl", 
...
f <- function(x) {
    ...
    targetspath <- system.file("extdata", "targets.txt", package="systemPipeR")
    dir_path <- "param/cwl" 
    args <- loadWorkflow(targets=targetspath, wf_file="hisat2/hisat2-mapping-se.cwl", input_file="hisat2/hisat2-mapping-se.yml", dir_path=dir_path)
    args <- renderWF(args, inputvars=c(FileName="_FASTQ_PATH1_", SampleName="_SampleName_"))
