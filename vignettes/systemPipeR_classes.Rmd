...
If you desire a different names for the logs folder and the `yaml` file, these can be 
modify as follows:
...
getColumn(sal, step=1, "outfiles", column = 1)

getColumn(sal, "outfiles", step="Quality", column = "trimmomatic_1_unpaired")

getColumn(sal, "outfiles", step="Quality", column = "trimmomatic_1_unpaired", names=SampleName(sal, step=1))


getColumn(sal, "outfiles", step="Quality", column = "trimmomatic_1_unpaired", names=rep("a", 18)) # we may need another method for factor...
