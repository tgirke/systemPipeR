...
Rscript -e "rmarkdown::render('systemPipeRIBOseq.Rmd', c('html_document'), clean=F); knitr::knit('systemPipeRIBOseq.Rmd', tangle=TRUE)"; Rscript ../md2jekyll.R systemPipeRIBOseq.knit.md 6; Rscript -e "rmarkdown::render('systemPipeRIBOseq.Rmd', c('pdf_document'))"
-->
