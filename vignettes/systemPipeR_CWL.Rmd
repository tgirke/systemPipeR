...
Even though the variable pattern `_XXXX_` is not required, we recommend adopting for consistency and easy identification as the variable notation rather them an argument.
...
to match with column names in the `targets` file and the value must match the 
names of the *.yml* variables.
