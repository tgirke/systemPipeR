...
software %>%
  dplyr::mutate(Step = kableExtra::cell_spec(Step, color = "white", bold = T,
...
Save table with filter DEG results for up and down-regulated genes for a specific sample comparison, as follows: 

```{r edger_deg_table, eval=FALSE}
edgeDF_M12_A12 <- edgeDF[DEG_list$UporDown$`M12-A12`,31:35]
write.table(edgeDF_M12_A12, "./results/edgeDF_M12_A12.xls", quote=FALSE, sep="\t", col.names = NA)   
```
