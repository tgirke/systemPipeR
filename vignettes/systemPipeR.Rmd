...
vignette: |
  ...
  %\VignetteIndexEntry{systemPipeR: Workflow and Visualization Toolkit}
...
knitr::include_graphics(system.file("extdata/images", "general.png", package = "systemPipeR"))
```
...
knitr::include_graphics(system.file("extdata/images", "SYSargsList.png", package = "systemPipeR"))
```
