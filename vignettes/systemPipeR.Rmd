...
The main motivation and advantages of using *sytemPipeR* for complex data analysis tasks are:
...
This tutorial introduces the design of a new CWL S4 class in *systemPipeR*, 
...
<div align="center">**Figure 2:** Workflow design structure of *systemPipeR* using _`SYSargs`_. </div></br>
