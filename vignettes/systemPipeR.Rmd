...
necessary update the corresponding _`.cwl`_ and _`.yml`_ files. A collection of pre-generated _`.cwl`_ and _`.yml`_ files is provided in the _`param/cwl`_ subdirectory of each workflow template. They
...
Running all the jobs to compute nodes.
